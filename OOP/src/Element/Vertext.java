...
public class Vertext extends Circle implements Comparable<Vertext> {
	...
	public Vertext(double x, double y, int id, double h, double g, double f, String text, String textg, String textf, Paint color) {
		...
		this.textf.setTextFill(Color.GREEN);
		this.textf.setStyle(Configuration.textColor);
		...
		this.textf.setLayoutX(this.getCenterX() + radius);
		this.textf.setLayoutY(this.getCenterY() + radius);
	}
	// copy vertext
